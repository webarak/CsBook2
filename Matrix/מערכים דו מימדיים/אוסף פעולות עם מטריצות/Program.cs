...
namespace אוסף_פעולות_עם_מטריצות
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0:F2}", avg(M));

            printalacsonR(M);
            Console.WriteLine(sumalacsonR(M));

            printalacsonM(M);
            Console.WriteLine(sumalacsonM(M));
            
            follownumber(M);
            print(M);

            Console.WriteLine(sumabovealacsonR(M));

            Console.WriteLine(sumnderalacsonR(M));

            printnderalacsonR(M);

            printabovealacsonR(M);

            Console.WriteLine(isexist(M, 5));

            printappear(M, 5);

            Console.WriteLine(sumappears(M, 5));

            printshura(M, 2);

            Console.WriteLine(sumshura(M, 2));

            printamuda(M, 2);

            Console.WriteLine(sumamuda(M, 2));
            ...
            Console.WriteLine(small(M));

            int[] arr = allsumsahura(M);
            ArrayService.print(arr);

            int[] brr = allsumsamuda(M);
            ArrayService.print(brr);
