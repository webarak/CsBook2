...
namespace _22._1._19
{
    class Program
    {
        ...
        {
            //טענת כניסה : קבלת מספר ומערך
            //טענת יציאה : מוחקת את המספר מהמערך
            int m = placenappearence(a, num);
        ...
        public static void deletemore(int[] a, int num)
        {
            //טענת כניסה : קבלת מספר ומערך
            //טענת יציאה : מוחקת את המספר בכל המקומות בהם מופיע במערך
            while (appear(a, num) == true)
            {
                delete(a, num);
            }
        }
        ...
        {
            //טענת כניסה : קבלת מערך
            //טענת יציאה : הזזת כל איברי המערך שמאלה
            int p = a[0];
            for (int i = 0; i < a.Length-1; i++)
            {
                a[i] = a[i + 1];
        ...
        {
            //טענת כניסה : קבלת מערך
            //טענת יציאה : הזזת כל איברי המערך ימינה
            int p = a[a.Length - 1];
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(bigest(arr));

            Console.WriteLine(tiniest(arr));

            Console.WriteLine(bigestplace(arr));

            Console.WriteLine(tiniestplace(arr));

            Console.WriteLine(appear(arr, 10));

            Console.WriteLine(placenappearence(arr, 10));

            Console.WriteLine(uporder(arr));

            Console.WriteLine(samenum(arr));

            Console.WriteLine(numberofappearence(arr, 10));

            Console.WriteLine(differentnum(arr));
